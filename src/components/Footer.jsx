        ...
        <div className="row g-4">
          ...
          <div className="col-lg-2 col-md-6">
            ...
            <ul className="list-unstyled">
              <li className="mb-2">
                <a href="#como-funciona" className="text-light opacity-75 text-decoration-none hover-link">
                  Como Funciona
                </a>
              </li>
              <li className="mb-2">
                <a href="#missoes" className="text-light opacity-75 text-decoration-none hover-link">
                  Missões
                </a>
              </li>
              <li className="mb-2">
                <a href="#herois" className="text-light opacity-75 text-decoration-none hover-link">
                  Nossos Heróis
                </a>
              </li>
              <li className="mb-2">
                <a href="#faq" className="text-light opacity-75 text-decoration-none hover-link">
                  FAQ
                </a>
              </li>
            </ul>
          ...
          <div className="col-lg-4 col-md-6">
            ...
            <div className="contact-info">
              ...
              <div className="contact-item mb-3">
                ...
                <a href="mailto:contato@mundorealrpg.com.br" className="text-light opacity-75 text-decoration-none hover-link">
                  contato@mundorealrpg.com.br
                </a>
              </div>
        ...
        <div className="row align-items-center">
          <div className="col-md-6">
            <p className="mb-0 text-light opacity-50">
              © 2025 Mundo Real RPG. Todos os direitos reservados.
            </p>
          </div>
          <div className="col-md-6 text-md-end">
            <div className="legal-links">
              <a href="#" className="text-light opacity-50 text-decoration-none me-3 hover-link">
                Política de Privacidade
              </a>
              <a href="#" className="text-light opacity-50 text-decoration-none me-3 hover-link">
                Termos de Uso
              </a>
              <a href="#" className="text-light opacity-50 text-decoration-none hover-link">
                LGPD
              </a>
            </div>
          </div>
