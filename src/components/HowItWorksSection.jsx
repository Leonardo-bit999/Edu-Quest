  ...
  const steps = [
    {
      ...
      description:
        "Cada aluno cria seu personagem único com habilidades e características especiais",
    ...
    },
    {
      ...
      description:
        "Transformamos conteúdos educacionais em missões épicas e desafios envolventes",
      icon: "bi-map-fill",
      color: "text-success",
    },
    {
      ...
      description:
        "Ganhe pontos e desbloqueie conquistas conforme avança no aprendizado",
      icon: "bi-trophy-fill",
      color: "text-warning",
    },
    {
      ...
      description:
        "Compete com amigos, forme equipes e participe de torneios educacionais",
      icon: "bi-people-fill",
      color: "text-danger",
    },
  ];
